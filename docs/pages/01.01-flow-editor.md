...
Objects (nodes, links and comments) on the flow editor canvas can be selected by clicking and then Commnad/Ctrl + click to add other objects to the set of selected objects.
