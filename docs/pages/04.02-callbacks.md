...
The callback receives an object with `panelId` and `label` properties, and should return a string or JSX element to be used as the panel title, or null to use the default label.
