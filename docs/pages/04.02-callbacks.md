...
```
To control whether a node shows the help icon in the right flyout, a help object with optional helpData needs to be provided in the paramDef or formData:
...
- formData: add help object to form definition: https://github.com/elyra-ai/pipeline-schemas/blob/master/common-canvas/form/form-v3-schema.json#L51
