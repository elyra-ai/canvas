...
The positions of ports on nodes affect the direction that links are drawn to/fom the ports. See this [overriding port positions](03.06.01-node-customization.md/#overriding-port-position-and-link-direction) section in the node customization page for more details.
