...
The four 'ports' options for [enableLinkDirection](03.02.01-canvas-config.md/#enablelinkdirection) canvas config ("LeftRight", "RightLeft", "TopBottom" and "BottomTop") will control the default position of the input and output ports at the boundaries of the nodes as follows:
