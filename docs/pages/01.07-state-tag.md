...
!!! note
    It is the application's responsibility for making the flow read-only. See the [Read Only or Locked Flows](03.09-read-only-or-locked-flows.md) page for more details.
