...
Action buttons can separated by dividers so that related buttons can be grouped together:
...
Action buttons in the toolbar can be shown as enabled or disabled:
