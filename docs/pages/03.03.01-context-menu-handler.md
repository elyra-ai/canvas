...
This callback will be called if the [`enableContextToolbar`](03.02.01-canvas-config.md#enablecontexttoolbar) canvas config option is set to `true` and when the mouse cursor is **hovered over** any of the objects mentioned above.
