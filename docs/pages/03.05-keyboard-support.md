...
|Shift + Alt + [down arrow key] |-| Move focus to first sub-object (port/decoration) in the focused node or link|
...
Focus is initially moved to the sub-objects of a node or link by pressing `Shift + Alt + [down arrow key]`. After that the following short cuts are available.

|Keyboard Shortcut|Action|Description|
|---|---|---|
|[tab key] or Shift + Alt + [down arrow key] |-| Move focus to next sub-object (port/decoration/link-handle) in the focused node or link|
|Shift + [tab key] or Shift + Alt + [up arrow key] |-| Move focus to previous sub-object (port/decoration/link-handle) in the focused node or link|
