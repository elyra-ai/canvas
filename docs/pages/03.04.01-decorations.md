...
#### **rotate**
A Boolean. The default is false. Only applicable to decorations added to a "Straight" link. When set to true, the decoration will be rotated to the same angle as the link line.
