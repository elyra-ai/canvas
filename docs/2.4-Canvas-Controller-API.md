...
Note: See this section for differences between [the structure of objects in the API and the schema.](/2.4.3-Object-structure-used-by-API#api-differences-with-schema) 

Also, this section discusses different [techniques for calling the canvas controller API](/2.4.0-Calling-the-Canvas-Controller-API).
...
The notification panel is displayed by the user by clicking the notifications icon in the toolbar. Your application can display whatever messages it wants in the notification panel. See the [Notification Messages Specification](/2.4.4-Notification-Message-Specification) documentation for the structure of message objects. The contents of the notification panel can be managed using the methods below: 
```js
...
* See this sections if you are working with [styles.](/2.4.1-Style-Specification) 
* See this section if you are working with [decorations.](/2.4.2-Decoration-Specification)
* See this section for differences between [the structure of objects in the API and the schema.](/2.4.3-Object-structure-used-by-API#api-differences-with-schema)
```js
