...
describe("ObjectModel handle model OK", () => {
	...
	it("should clear a canvas", () => {
		...
		const startCanvas =
			{ diagram:
			{ nodes: [
               { id: "node1", x_pos: 10, yPos: 10 },
               { id: "node2", x_pos: 20, yPos: 20 },
               { id: "node3", x_pos: 30, yPos: 30 }
			],
				comments: [
               { id: "comment1", x_pos: 50, yPos: 50 },
               { id: "comment2", x_pos: 60, yPos: 60 }
				]
			}
			};
		...
		const expectedCanvas =
			...
			{ nodes: [
				...
				{ id: "node4", className: "canvas-node", image: "imageName",
					outputPorts: [{ name: "outPort", label: "Output Port", cardinality: "1:1" }],
					inputPorts: [{ name: "inPort", label: "Input Port", cardinality: "1:1" }],
					x_pos: 40, yPos: 40, objectData: { description: "", label: "Type" } }
			],
				comments: [
					{ id: "comment1", x_pos: 50, yPos: 50 },
					{ id: "comment2", x_pos: 60, yPos: 60 }
	...
	it("should move a node", () => {
		...
		const expectedCanvas =
			{ diagram:
			{ nodes: [
               { id: "node1", x_pos: 15, yPos: 17 },
               { id: "node2", x_pos: 25, yPos: 27 },
               { id: "node3", x_pos: 35, yPos: 37 }
			],
				comments: [
               { id: "comment1", x_pos: 50, yPos: 50 },
               { id: "comment2", x_pos: 60, yPos: 60 }
	...
	it("should add node attr", () => {
		...
		const expectedCanvas =
			{ zoom: 100,
				diagram: {
					nodes: [
							{ "id": "node1", "x_pos": 10, "yPos": 10, "customAttrs": ["bgcolor"] },
							{ id: "node2", x_pos: 20, yPos: 20 },
							{ id: "node3", x_pos: 30, yPos: 30 }
					],
					comments: [
	...
	it("should remove node attr", () => {
		...
		const expectedCanvas =
			{ zoom: 100,
				diagram: {
					nodes: [
							{ "id": "node1", "x_pos": 10, "yPos": 10, "customAttrs": [] },
							{ id: "node2", x_pos: 20, yPos: 20 },
							{ id: "node3", x_pos: 30, yPos: 30 }
					],
					comments: [
		...
		const expectedCanvas =
			...
			{ nodes: [
               ...
               { id: "node3", x_pos: 30, yPos: 30 }
				...
				comments: [
               { id: "comment1", x_pos: 55, yPos: 57 },
               { id: "comment2", x_pos: 65, yPos: 67 }
				],
				links: []
			}
			};
		...
		const expectedCanvas =
			{ zoom: 100,
				diagram: {
					...
					comments: [
								{ "id": "comment1", "x_pos": 50, "yPos": 50, "customAttrs": ["bgcolor"] },
								{ id: "comment2", x_pos: 60, yPos: 60 }
					],
					links: [
								{ id: "link1", source: "node1", target: "node2" },
		...
		const expectedCanvas =
			{ zoom: 100,
				diagram: {
					...
					comments: [
								{ "id": "comment1", "x_pos": 50, "yPos": 50, "customAttrs": [] },
								{ id: "comment2", x_pos: 60, yPos: 60 }
					],
					links: [
								{ id: "link1", source: "node1", target: "node2" },
			...
			{ zoom: 100,
				diagram: {
					nodes: [
						...
						{ id: "node4", x_pos: 40, yPos: 30 },
						{ id: "node5", x_pos: 50, yPos: 30 },
						{ id: "node6", x_pos: 60, yPos: 30 },
						{ id: "node7", x_pos: 70, yPos: 30 },
						{ id: "node8", x_pos: 80, yPos: 30 },
						{ id: "node9", x_pos: 90, yPos: 30 },
						{ id: "node10", x_pos: 100, yPos: 30 },
						{ id: "node11", x_pos: 110, yPos: 30 },
						{ id: "node12", x_pos: 120, yPos: 30 },
						{ id: "node13", x_pos: 130, yPos: 30 }
					],
					comments: [
						{ id: "comment1", x_pos: 50, yPos: 50 },
						{ id: "comment2", x_pos: 60, yPos: 60 }
