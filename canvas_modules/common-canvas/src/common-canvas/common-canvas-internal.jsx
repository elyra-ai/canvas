...
class CommonCanvasInternal extends React.Component {
	constructor(props) {
		super(props);

		this.logger = new Logger(["CommonCanvasInternal"]);
...
CommonCanvasInternal.propTypes = {
	...
	setTopPanelConfig: PropTypes.func,
	setBottomPanelConfig: PropTypes.func
};

const mapDispatchToProps = (dispatch, ownProps) => {
	return ({
		setTopPanelConfig: () =>
			dispatch({ type: "SET_TOP_PANEL_CONFIG", data: { config: { content: ownProps.topPanelContent, isOpen: ownProps.showTopPanel } } }),
		setBottomPanelConfig: () =>
			dispatch({ type: "SET_BOTTOM_PANEL_CONFIG", data: { config: { content: ownProps.bottomPanelContent, isOpen: ownProps.showBottomPanel } } })
	});
};

export default connect(null, mapDispatchToProps)(injectIntl(CommonCanvasInternal));
