...
export const ACTION_CONNECT_FROM_PORT = "connectFromPort";
export const ACTION_CONNECT_TO_PORT = "connectToPort";
export const ACTION_CLIPBOARD = "clipboard";
export const ACTION_CREATE_COMMENT = "createComment";
export const ACTION_CREATE_AUTO_COMMENT = "createAutoComment";
export const ACTION_CREATE_WYSIWYG_COMMENT = "createWYSIWYGComment";
export const ACTION_CREATE_AUTO_WYSIWYG_COMMENT = "createAutoWYSIWYGComment";
export const ACTION_SET_COMMENT_EDIT_MODE = "setCommentEditingMode";
export const ACTION_SHOW_COMMENTS = "commentsShow";
export const ACTION_HIDE_COMMENTS = "commentsHide";
export const ACTION_COLOR_BACKGROUND = "colorBackground";
export const ACTION_DELETE_LINK = "deleteLink";
export const ACTION_DELETE_SELECTED_OBJECTS = "deleteSelectedObjects";
export const ACTION_ZOOM_IN = "zoomIn";
export const ACTION_ZOOM_OUT = "zoomOut";
export const ACTION_ZOOM_FIT = "zoomToFit";
export const ACTION_ARRANGE_HORIZONTALLY = "arrangeHorizontally";
export const ACTION_ARRANGE_VERTICALLY = "arrangeVertically";
export const ACTION_TOGGLE_NOTIFICATION_PANEL = "toggleNotificationPanel";
export const ACTION_OPEN_PALETTE = "openPalette";
export const ACTION_CLOSE_PALETTE = "closePalette";
export const ACTION_TOGGLE_PALETTE = "togglePalette";
export const ACTION_EXPAND_SUPERNODE_IN_PLACE = "expandSuperNodeInPlace";
export const ACTION_COLLAPSE_SUPERNODE_IN_PLACE = "collapseSuperNodeInPlace";
export const ACTION_EXPAND_SUPERNODE_FULL_PAGE = "displaySubPipeline";
export const ACTION_SET_NODE_LABEL_EDIT = "setNodeLabelEditingMode";
export const ACTION_SET_NODE_DECORATION_LABEL_EDIT = "setNodeDecorationLabelEditingMode";
export const ACTION_SET_COMMENT_DECORATION_LABEL_EDIT = "setCommentDecorationLabelEditingMode";
export const ACTION_SET_LINK_DECORATION_LABEL_EDIT = "setLinkDecorationLabelEditingMode";
export const ACTION_SELECT_ALL = "selectAll";
export const ACTION_DESELECT_ALL = "deselectAll";
export const ACTION_TOGGLE_COMMENTS = "commentsToggle";
export const ACTION_SET_ZOOM = "setZoom";
export const ACTION_OPEN_NOTIFICATION_PANEL = "openNotificationPanel";
export const ACTION_CLOSE_NOTIFICATION_PANEL = "closeNotificationPanel";
export const ACTION_LOAD_PIPELINE_FLOW = "loadPipelineFlow";
export const ACTION_DISPLAY_PREVIOUS_PIPELINE = "displayPreviousPipeline";
export const ACTION_COLOR_SELECTED_OBJECTS = "colorSelectedObjects";
export const ACTION_DISCONNECT_NODE = "disconnectNode";
export const ACTION_SAVE_TO_PALETTE = "saveToPalette";
export const ACTION_CREATE_NODE = "createNode";
export const ACTION_CREATE_AUTO_NODE = "createAutoNode";
export const ACTION_CREATE_NODE_ON_LINK = "createNodeOnLink";
export const ACTION_CREATE_NODE_ATTACH_LINKS = "createNodeAttachLinks";
export const ACTION_CREATE_SUPERNODE = "createSuperNode";
export const ACTION_CREATE_SUPERNODE_EXTERNAL = "createSuperNodeExternal";
export const ACTION_DECONSTRUCT_SUPERNODE = "deconstructSuperNode";
export const ACTION_CONVERT_SUPERNODE_EXTERNAL_TO_LOCAL = "convertSuperNodeExternalToLocal";
export const ACTION_CONVERT_SUPERNODE_LOCAL_TO_EXTERNAL = "convertSuperNodeLocalToExternal";
export const ACTION_INSERT_NODE_INTO_LINK = "insertNodeIntoLink";
export const ACTION_ATTACH_NODE_TO_LINKS = "attachNodeToLinks";
export const ACTION_MOVE_OBJECTS = "moveObjects";
export const ACTION_RESIZE_OBJECTS = "resizeObjects";
export const ACTION_SET_OBJECTS_STYLE = "setObjectsStyle";
export const ACTION_SET_LINKS_STYLE = "setLinksStyle";
export const ACTION_UPDATE_LINK = "updateLink";
export const ACTION_SET_NODE_LABEL = "setNodeLabel";
export const ACTION_EDIT_COMMENT = "editComment";
export const ACTION_EDIT_DECORATION_LABEL = "editDecorationLabel";
export const ACTION_LINK_NODES = "linkNodes";
export const ACTION_LINK_NODES_AND_REPLACE = "linkNodesAndReplace";
export const ACTION_LINK_COMMENT = "linkComment";
export const ACTION_CREATE_DETACHED_LINK = "createDetachedLink";
export const ACTION_BEGIN_NEW_LINK = "beginNewLink";
export const ACTION_CREATE_FROM_EXTERNAL_OBJECT = "createFromExternalObject";
export const ACTION_HIGHLIGHT_BRANCH = "highlightBranch";
export const ACTION_HIGHLIGHT_UPSTREAM = "highlightUpstream";
export const ACTION_HIGHLIGHT_DOWNSTREAM = "highlightDownstream";
export const ACTION_UNHIGHLIGHT = "unhighlight";
