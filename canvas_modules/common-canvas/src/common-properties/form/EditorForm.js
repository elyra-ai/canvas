...
function _makeAction(action, l10nProvider) {
	...
	return new Action(action.id, actionLabel, actionDesc, action.control, action.data, action.image, action.button, action.svg, action.className, action.customActionId);
}
