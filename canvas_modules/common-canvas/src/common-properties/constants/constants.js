...
_defineConstant("MESSAGE_KEYS_DEFAULTS", {
	...
	PROPERTIES_ERROR: "We are unable to process your request due to an error in one of the Common Properties component",
	PROPERTIES_UNEXPECTED_MESSAGE: "Whoops. That was unexpected.",
