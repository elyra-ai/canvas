...
export default class Icon extends React.Component {
	getIcon(type) {
		switch (type) {
		case ("measurementEmpty"):
			return (<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 18 18" fill="none">
		...
		case ("measurementOrdinal"):
			return (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className={CLASS_NAME + " fill"}>
