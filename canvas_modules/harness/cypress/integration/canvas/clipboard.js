...
describe("Test for clipboard Cut and Paste context menu items", function() {
	...
	it("Test cutting some nodes and a comment and paste to canvas using browser's edit menu", function() {
		...
		// Cut nodes and comment using browser's Edit menu
		cy.simulateClickInBrowsersEditMenu("cut");

		// Paste nodes and comment using browser's Edit menu
...
describe("Test for clipboard menu items on Browser Edit menu", function() {
	before(() => {
		cy.visit("/");
		cy.openCanvasDefinition("commentColorCanvas.json");
	});
	...
	it("Test copying some nodes and a comment and paste to canvas using browser's edit menu", function() {
		...
		// Copy nodes and comment using browser's Edit menu
