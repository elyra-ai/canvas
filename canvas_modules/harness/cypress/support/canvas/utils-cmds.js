...
Cypress.Commands.add("getCanvasTranslateCoords", () => {
	cy.get(`div#canvas-div-${document.instanceId} > div[role='region'] > .svg-area > g`)
		.then((g) => {
...
Cypress.Commands.add("getCanvasBackgroundTranslateCoords", () => {
	cy.get(`div#canvas-div-${document.instanceId} > div[role='region'] > .svg-area > .d3-svg-background-grid`)
		.then((background) => {
