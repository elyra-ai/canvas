 ...
 */
// Modules
import { HTTP_STATUS_NOT_FOUND, HTTP_STATUS_OK, TEST_RESOURCES_PALETTES_PATH } from "../lib/constants.js";
import { readFile, readdir } from "fs";
import { join } from "path";
import log4js from "log4js";

const logger = log4js.getLogger("v1-get-palettes-list-controller");

export const get = _get;

function _get(req, res) {
	logger.info("Retrieving list of files");
	var dirPath = join(import.meta.dirname, TEST_RESOURCES_PALETTES_PATH);
