 ...
 */
// Modules
import { HTTP_STATUS_NOT_FOUND, HTTP_STATUS_OK, TEST_RESOURCES_FORMS_PATH } from "../lib/constants";
import { readFile, readdir } from "fs";
import { getLogger } from "log4js";
import { join } from "path";

const logger = getLogger("v1-get-forms-list-controller");
...
function _get(req, res) {
	...
	var dirPath = join(__dirname, TEST_RESOURCES_FORMS_PATH);
