	...
	"expressionInfo": {
		...
		"function_info": [
			...
			},
			{
				...
				"help":
				"Returns the number of values from a LIST of fields that are equal to ITEM1, or NULL if ITEM1 is NULL."
			},
			{
				"label": "datetime_date",
				"return_type": "Date",
			...
			},
			{
				...
				"help":
				"Returns the time value for the specified HOUR, MINUTE, and SECOND. The arguments must be integers."
			},
			{
