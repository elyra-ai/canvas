Feature: Sanity_Test_ContextMenuPosition
  ...
  ** Make sure the test harness is running and listening to http://localhost:3001 ***
  ...
  Scenario: Sanity test empty canvas with D3 rendering engine
    ...
    Given I have toggled the app side panel
		...
		Then I right click the canvas background at 1000, 300 to display the context menu
		Then I verify the context menu is at 1000, 300
		...
		Then I verify the context menu is at 1140, 349
		...
		Then I verify the context menu is at 1000, 349
		...
		Then I right click the canvas background at 940, 300 to display the context menu
		Then I verify the context menu is at 780, 300
		...
		Then I right click the canvas background at 640, 300 to display the context menu
		Then I verify the context menu is at 480, 300
