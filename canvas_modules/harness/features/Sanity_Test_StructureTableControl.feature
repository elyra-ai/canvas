Feature: Sanity_Test_StructureTableControl
	...
	** Make sure the test harness is running and listening to http://localhost:3001 ***
	...
	Scenario: Test generatedValues in structure table control
		...
		Then I click on the "OK" button
		Then I verify the event log for the "structuretableReadonlyColumnDefaultIndex" parameter contains "1,BP,BP-1,blood pressure,,1982-02-23T12:00:00Z,2,Na,Na,,string,,3,K,K,,string,,4,Drug,Drug,,string,"
